...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2021 at 04:38 PM
...
INSERT INTO `jurusan` (`id`, `id_prodi`, `jurusan`, `keterangan`) VALUES
(1, 0, 'TI', 'Teknologi Infromasi'),
(2, 1, 'TS', 'Teknik Sipil'),
(3, 2, 'TM', 'Teknik Mesin'),
(4, 3, 'TE', 'Teknik Elektro'),
(5, 4, 'AK', 'Akutansi'),
(6, 5, 'ADN', 'Adminitrasi Niaga'),
(7, 6, 'BING', 'Bahasa Inggris');
...
(2, '1911082111', 'Conan', '17-Feb-2000', 'L', 1, 203001, 'conan@gmail.com', 'Bandung'),
(3, '1911081024', 'Siska Nofri Dania', '03-Nov-2001', 'P', 0, 203003, 'daniasiskanofri@gmail.com', 'Kp,jambu Pariaman'),
(4, '1911087777', 'Digimon', '20-Jun-1999', 'L', 0, 203002, 'digimon@gmail.com', 'Padang'),
(5, '1911081111', 'Saylor moon', '01-Nov-2003', 'P', 0, 203002, 'say@gmail.com', 'Suger'),
(6, '1911080111', 'Papazola', '02-Jun-1998', 'L', 0, 203003, 'papaz@gmail.com', 'Jakarta'),
(7, '1911080199', 'Yaya', '04-Jul-2001', 'L', 0, 203001, 'yayay@gmail.com', 'Sulim'),
(8, '1911080810', 'Ying', '05-Aug-2002', 'P', 0, 203003, 'ying@gmail.com', 'Palembang'),
(9, '1911080988', 'Ocobot', '02-Sep-1987', 'L', 0, 203002, 'ocobot@gmail.com', 'Padang'),
(10, '1911081079', 'Gopal', '02-May-2000', 'L', 0, 203002, 'gopal@gmail.com', 'Kp,Baru Padang'),
(11, '1911080923', 'Adambes', '19-Feb-2021', 'L', 0, 203003, 'adambes@gmail.com', 'Tanggerang');
...
(203004, 'PTM', 'D3 Teknik Mesin'),
(203005, 'PTS', 'D3 Teknik Sipil'),
(203006, 'PJJ', 'D4 Perencanaan Jalan Dan Jembatan'),
(203007, 'PIR', 'D4 Perencanaan Irigasi Dan Rawa'),
(203008, 'MRK', 'Manajemen Rekayasa Konstruksi'),
(203009, 'TL', 'D3 Teknik Listrik'),
(2030010, 'PTE', 'D3 Teknik Elektronika'),
(2030011, 'TT', 'D3 Teknik Telekomunikasi'),
(2030012, 'TEL', 'D4 Teknik Elektronika'),
(2030013, 'TELKOM', 'D4 Teknik Telekomunikasi'),
(2030014, 'AKUN', 'D3 Akutansi'),
(2030015, 'AKUTAN', 'D4 Akutansi'),
(2030016, 'AB', 'D3 Administrasi Bisnis'),
(2030017, 'UPW', 'D3 Usaha Perjalanan Wisata'),
(2030018, 'BI', 'D3 Bahasa Inggris');
...
--
ALTER TABLE `prodi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2030019;
